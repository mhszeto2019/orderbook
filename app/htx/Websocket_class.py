...
from util import decoder, unix_ts_to_datetime,standardised_ccy_naming,format_arr_4dp
...
class Ws_orderbook(WsBase):
    ...
    def process_tick_data(self, response_data):
        ...
        filtered_bids,filtered_asks = format_arr_4dp(bids), format_arr_4dp(asks)
...
class Ws_orderbook_swaps(WsBase):
    ...
    def process_tick_data(self, response_data):
        ...
        # global last_ask_price_htx
        # global last_ask_size_htx
        # global last_bid_price_htx
        # global last_bid_size_htx

        # last_bid_price_htx, last_bid_size_htx = bidPrice, bidSize
        # last_ask_price_htx, last_ask_size_htx = askPrice, askSize
        # Store the data in Redis using the currency as the key
