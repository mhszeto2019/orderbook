...
class DatabaseNotificationListener:
    def __init__(self, db_config, channel, filter_username=None,callback = None):
        """
...
class Strat:
    ...
    def update_with_notification(self, data):
        """Update the main class with data received from the listener."""
        print(f"Updating main class with data: {data}")
