...
SERVICES_PORTS=(
  ...
  ["htx_orderbook_ws"]=$HTX_DISPLAY_ORDERBOOK_PORT #WS
...
ExecStart=$ENV_PATH/bin/uvicorn app.fastapi.htxperp.ws.public.$SERVICE_NAME:app --port $PORT --host 0.0.0.0 --reload
