...
SERVICES_PORTS=(
  ...
  ["get_deribit_positions"]=$OKX_DISPLAY_ASSET_AND_POSITION_PORT #REST
  ["get_deribit_orders"]=$OKX_DISPLAY_OPEN_ORDERS_PORT #REST
  ["place_deribit_order"]=$OKX_TRADING_PORT
