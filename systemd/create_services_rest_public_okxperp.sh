...
SERVICES_PORTS=(
  ...
  ["get_okx_last_trades"]=$OKX_DISPLAY_LAST_TRADES_PORT #REST
...
ExecStart=$ENV_PATH/bin/uvicorn app.fastapi.okxperp.rest.public.$SERVICE_NAME:app --port $PORT --host 0.0.0.0 --reload
