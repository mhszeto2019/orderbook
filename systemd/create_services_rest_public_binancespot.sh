...
SERVICES_PORTS=(
  ...
  ["get_binancespot_last_trades"]=$BINANCESPOT_DISPLAY_LAST_TRADES_PORT #REST
...
ExecStart=$ENV_PATH/bin/uvicorn app.fastapi.binancespot.rest.public.$SERVICE_NAME:app --port $PORT --host 0.0.0.0 --reload
