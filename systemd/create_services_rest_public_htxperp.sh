...
SERVICES_PORTS=(
  ...
  ["get_htx_last_trades"]=$HTX_DISPLAY_LAST_TRADES_PORT #REST
...
ExecStart=$ENV_PATH/bin/uvicorn app.fastapi.htxperp.rest.public.$SERVICE_NAME:app --port $PORT --host 0.0.0.0 --reload
